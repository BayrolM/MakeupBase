      ...
      <div className="p-4 border-b border-gray-100 bg-white">
        <div className="relative w-full">
          ...
          <input
            ...
            placeholder="Buscar por nombre o estado (ej: activo, inactivo)..."
          />
          {searchQuery && (
            <button
        ...
        <TableHeader>
          <TableRow className="bg-[#fff0f5] border-b-2 border-[#fce8f0]">
            ...
            <TableHead className="text-gray-700 font-semibold text-xs uppercase tracking-wider py-3">
              <div className="flex items-center gap-1.5">
                <Shield className="w-3.5 h-3.5" /> Nombre del Rol
              </div>
            </TableHead>
            <TableHead className="text-gray-700 font-semibold text-xs uppercase tracking-wider py-3">
              <div className="flex items-center gap-1.5">
                <UsersIcon className="w-3.5 h-3.5" /> Usuarios
              </div>
            </TableHead>
            <TableHead className="text-gray-700 font-semibold text-xs uppercase tracking-wider py-3">
              <div className="flex items-center gap-1.5">
