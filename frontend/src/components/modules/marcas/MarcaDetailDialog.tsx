...
interface MarcaDetailDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  marca: Marca | null;
}

export function MarcaDetailDialog({
  open,
  onOpenChange,
  marca,
}: MarcaDetailDialogProps) {
        ...
        <div className="px-6 py-5 flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gray-50 rounded-xl p-4">
              ...
              <p className="text-sm font-bold text-gray-800">{marca.nombre}</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-4">
