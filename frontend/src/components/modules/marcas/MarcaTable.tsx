        ...
        <Table>
          ...
          <TableBody>
            {marcas.length === 0 ? (
                ...
                <TableCell colSpan={5} className="text-center py-20">
                  <div className="flex flex-col items-center gap-4">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#fff0f5] to-[#fce8f0] flex items-center justify-center">
                      <Tags className="w-10 h-10 text-[#c47b96]" />
                    </div>
                    <div>
              ...
              marcas.map((marca) => {
                const productCount = getMarcaProductCount(
                  marca.id,
                  productos,
                );
                  ...
                  >
                    ...
                    <TableCell className="py-2.5">
                      <StatusSwitch
                        status={marca.estado}
                        onChange={(newStatus) =>
                          onStatusChange(marca.id, newStatus)
                        }
                        disabled={!isAdmin}
                      />
                    </TableCell>
