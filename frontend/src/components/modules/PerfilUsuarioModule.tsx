...
export function PerfilUsuarioModule() {
  ...
  return (
    <div
      className="min-h-screen relative pb-12 w-full"
          ...
          >
            <div style={{ position: "relative", marginBottom: "20px" }}>
              ...
              >
                {previewPhoto ? (
                  ...
                  <User
                    style={{ width: 80, height: 80, color: C.accentDeep }}
                  />
                )}
              </div>
              <label
            ...
            {photoFile && (
              <Button
                ...
                className="w-full luxury-button-premium mt-6"
              >
          ...
          <div className="col-span-12 xl:col-span-9 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div>
                ...
                >
                  {currentUser.ciudad || "Medellín, CO"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          >
            <div className="flex justify-between items-center mb-10 pb-6 border-b border-pink-50">
              <div>
                ...
                >
                  Gestión completa de datos de usuario y contacto legal
                </p>
              </div>
              {!isEditingInfo ? (
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8">
              <div className="space-y-3">
                ...
                <Input
                  ...
                  style={{
                    ...
                    background: isEditingInfo ? C.white : `${C.bgSoft}55`,
                    fontSize: "15px",
                  }}
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <Select
                  ...
                  onValueChange={(v) => handleInfoChange("tipoDocumento", v)}
                  disabled={!isEditingInfo}
                >
                  <SelectTrigger
                    style={{
          ...
          <div className="col-span-12 xl:col-span-4 space-y-8">
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                  ...
                  <p
                    style={{ fontSize: "12px", color: C.textMuted, margin: 0 }}
                  >
              ...
              <div className="space-y-5">
                ...
                <Button
                  ...
                  className="w-full luxury-button-premium mt-4 h-12"
            ...
            >
              ...
              >
                ¿Tienes dudas sobre tus permisos o necesitas ajustes avanzados
                en tu cuenta corporativa?
              </p>
              <button
                style={{
                  background: C.white,
