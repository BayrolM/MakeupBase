    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-white border border-gray-100 w-[95vw] max-w-[450px] sm:max-w-[450px] rounded-2xl shadow-2xl p-0 overflow-hidden">
        ...
        <div className="p-8 space-y-6">
          {pedidoToConfirm.estado === "cancelado" ? (
            <div 
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Este pedido ha sido cancelado. No es posible confirmar o cambiar el estado del pago.
                </p>
              </div>
            </div>
          ) : pedidoToConfirm.pago_confirmado ? (
            <div 
              className="rounded-2xl p-5 flex gap-4 border"
              style={{ 
            ...
            >
              ...
              <div className="space-y-1">
                <p className="text-sm font-bold text-gray-800">
                  El pago ya ha sido confirmado
                </p>
                <p className="text-xs text-gray-500 leading-relaxed">
                  Este pedido ya se encuentra con el pago confirmado. No es necesario realizar más acciones.
                </p>
              </div>
            </div>
          ) : (
          ...
          <div className="flex gap-3 pt-4 border-t border-gray-100 w-full">
            ...
            {pedidoToConfirm.estado !== "cancelado" && !pedidoToConfirm.pago_confirmado && (
              <Button
                type="button"
                onClick={onConfirm}
                disabled={isSaving}
