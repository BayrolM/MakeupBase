            ...
            users.map((user) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="py-2.5">
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-semibold ${rolBadge.bg} ${rolBadge.text}`}
                    >
                      {rolNombre}
                    </span>
                  </TableCell>
                  <TableCell className="py-2.5">
                    <div
                      title={
                        tieneActivos
                          ? `Tiene ${pedidosActivos.length} pedido(s) activo(s)`
                          : undefined
                      }
                    >
                      <StatusSwitch
