...
export function RegisterPageColombia({
  ...
  const validateField = (name: string, value: string) => {
    // Map local 'password' to 'passwordHash' used in utility
    ...
    // Specific logic for confirmPassword not in utility
    ...
    >
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          ...
          >
            Crea tu cuenta y descubre nuestra colección de productos de belleza
            y cuidado personal.
          </p>
        </div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    ...
                    >
                      <CreditCard
                        style={{ width: 14, height: 14, color: C.accentDeep }}
                      />{" "}
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.numeroDocumento ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor =
                          errors.numeroDocumento ? C.danger : C.accent)
                      }
                    />
                    {errors.numeroDocumento && (
                      <p
                        style={{ color: C.danger, fontSize: "11px", margin: 0 }}
                      >
                        {errors.numeroDocumento}
                      </p>
                    )}
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.nombres ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor = errors.nombres
                          ? C.danger
                          : C.accent)
                      }
                    />
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.apellidos ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor = errors.apellidos
                          ? C.danger
                          : C.accent)
                      }
                    />
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.email ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.telefono ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor = errors.telefono
                          ? C.danger
                          : C.accent)
                      }
                    />
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.ciudad ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor = errors.ciudad
                          ? C.danger
                          : C.accent)
                      }
                    />
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.departamento ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor = errors.departamento
                          ? C.danger
                          : C.accent)
                      }
                    />
                  ...
                  >
                    ...
                    <input
                      ...
                      style={{
                        ...
                        height: "44px",
                        borderRadius: "8px",
                        border: `1px solid ${errors.direccion ? C.danger : C.accent}`,
                        padding: "0 16px",
                        fontSize: "14px",
                        color: C.textDark,
                        outline: "none",
                      ...
                      onBlur={(e) =>
                        (e.currentTarget.style.borderColor = errors.direccion
                          ? C.danger
                          : C.accent)
                      }
                    />
                    ...
                    <div style={{ position: "relative" }}>
                      <input
                        ...
                        style={{
                          ...
                          height: "44px",
                          borderRadius: "8px",
                          border: `1px solid ${errors.password ? C.danger : C.accent}`,
                    ...
                    <div style={{ position: "relative" }}>
                      <input
                        ...
                        style={{
                          ...
                          height: "44px",
                          borderRadius: "8px",
                          border: `1px solid ${errors.confirmPassword ? C.danger : C.accent}`,
                          padding: "0 40px 0 16px",
                          fontSize: "14px",
                          color: C.textDark,
                          outline: "none",
                        ...
                        onBlur={(e) =>
                          (e.currentTarget.style.borderColor =
                            errors.confirmPassword ? C.danger : C.accent)
                        }
                      />
                      <button
                        type="button"
